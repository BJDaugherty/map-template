...
var map = L.mapbox.map('map', "bjdaugherty.1n4h6c05").setView([36.702161, 3.606765],
	9);
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 
	$.getJSON('https://bjdaugherty.cloudant.com/northafricademo/_design/tour/',
		function(result) {
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 	
	var cloudantURLbase =
		"https://bjdaugherty.cloudant.com/northafricademo/_design/tour/_view/";
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 	
	var cloudantURLbase =
		"https://bjdaugherty.cloudant.com/northafricademo/_design/tour/_search/ids?q=";
	var cloudantURLcallback = "&callback=?";
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 		
		var cloudantURLbase = "https://bjdaugherty.cloudant.com/northafricademo/";
